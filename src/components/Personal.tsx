...
export default function Personal() {
    return (
        <section id="personal" className="py-20 px-4 bg-zinc-900/30">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div>
                                <h4 className="text-sm font-medium text-zinc-300 mb-2">Currently Reading</h4>
                            ...
                            <div>
                                <h4 className="text-sm font-medium text-zinc-300 mb-2">On Deck</h4>
                            ...
                            <div>
                                <h4 className="text-sm font-medium text-zinc-300 mb-2">Recently Finished</h4>
                                <ul className="space-y-1 text-zinc-500 text-sm">
